...
library SignatureLib {
    ...
    bytes32 internal constant APPROVAL_TYPEHASH = keccak256("ApprovalMessage(uint256 proposalId,bytes32 actionHash,uint256 nonce,uint256 deadline)");
    ...
    function verifyApproval(bytes32 _domainSeparator, uint256 _proposalId, bytes32 _actionHash, uint256 _nonce, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) internal view returns (address signer) {
